...
import 'package:mvp_timer/pages/overview/mvp_hero_info.dart';
    ...
    return Stack(
      ...
      children: [
                ...
                child: BackdropFilter(
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                          border: Border.all(
                              width: 1, color: light.withOpacity(.5)),
        ...
        Positioned(
            ...
            bottom: 0,
            child:
                HeroActionButton(color: blue, onTap: () {}, icon: Icons.timer)),
        Positioned(
            right: 0,
            bottom: 50,
            child: HeroActionButton(
                color: red, onTap: () {}, icon: Icons.favorite)),
      ],
    );
  }
}
